...
/**
 * @ngdoc function
 * @name propertyAdminApp.controller:OwnersCtrl
 * @description
 * # OwnersCtrl
 * Controller of the propertyAdminApp
 */

  app.controller('OwnersCtrl', function ($rootScope, $scope, $state, $stateParams, $location, localStorageService, ngTableParams, Models, notify, ucauth) {
    $scope.key = 'owners';
