 ...
 */
app.controller('TeamFeedbackCtrl', function ($rootScope, $scope, $state, $stateParams, $location, localStorageService, ngTableParams, Models, notify, ucauth, ngDialog, config) {
  ...
  $scope.getPageList = function () {
    ...
    $scope.tableParams = new ngTableParams($scope.the_params, {
      ...
      getData: function ($defer, params) {
        ...
        var the_param = {teamId:$stateParams.teamId,pageSize: params.count(), pageIndex: params.page()};
  ...
  $scope.entry = function (item) {
    ...
    $state.go('admin.team.feedbackDetail', {itemId: item.autoId, action: 'entry'});
  };
