 ...
 */
app.controller('TeamCommentCtrl', function ($rootScope, $scope, $state, $stateParams, $location, localStorageService, ngTableParams, Models, config, notify, ngDialog, ucauth) {
  ...
  $scope.getPageList = function () {
    ...
    $scope.tableParams = new ngTableParams($scope.the_params, {
      ...
      getData: function ($defer, params) {
        ...
        var the_param = {pageSize: params.count(), pageIndex: params.page(),itemId:$stateParams.itemId};
