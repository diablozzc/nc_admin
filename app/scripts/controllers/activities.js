...
/**
 * @ngdoc function
 * @name propertyAdminApp.controller:ActivitiesCtrl
 * @description
 * # ActivitiesCtrl
 * Controller of the propertyAdminApp
 */

  app.controller('ActivitiesCtrl', function ($rootScope, $scope, $state, $stateParams, $location, localStorageService, ngTableParams, Models, notify, ucauth) {
