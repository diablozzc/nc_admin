...
/**
 * @ngdoc function
 * @name propertyAdminApp.controller:RepairssearcherCtrl
 * @description
 * # RepairssearcherCtrl
 * Controller of the propertyAdminApp
 */

  app.controller('RepairssearcherCtrl', function ($rootScope, $scope, $state, $stateParams, $location, localStorageService, ngTableParams, Models, notify, ucauth) {
    $scope.the_search = {};
